...
const Wine = props => {
  return (
    ...
    <div className="sub__container">
      <h4 className="sub__header">Wine</h4>
      <div className="sub__container--col">
        <div className="sub__list">
          <h4 className="sub__list--header">SPARKLING</h4>
          <h5 className="menu-item__header">LOS MONTEROS</h5>
          <p className="menu-item__details--description">SPAIN</p>
          <p className="menu-item__details--price">6 PER GLASS</p>
          <p className="menu-item__details--price">21 PER BOTTLE</p>

          <h5 className="menu-item__header">VENTURI LAMBRUSCO ROSE</h5>
          <p className="menu-item__details--description">ITALY</p>
          <p className="menu-item__details--price">8 PER GLASS</p>
          <p className="menu-item__details--price">28 PER BOTTLE</p>

          <h5 className="menu-item__header">ZONIN</h5>
          <p className="menu-item__details--description">PROSECCO</p>
          <p className="menu-item__details--price">10 PER GLASS</p>
          <p className="menu-item__details--price">35 PER BOTTLE</p>

          <h5 className="menu-item__header">MUMM BRUT</h5>
          <p className="menu-item__details--description">SPARKLING ROSE</p>
          <p className="menu-item__details--price">50 PER BOTTLE</p>

          <h5 className="menu-item__header">POMMERY BRUT ROYAL CHAMPAGNE</h5>
          <p className="menu-item__details--description">FRANCE</p>
          <p className="menu-item__details--price">95 PER BOTTLE</p>

          <h5 className="menu-item__header">VEUVE CLICQUOT CHAMPAGNE</h5>
          <p className="menu-item__details--description">FRANCE</p>
          <p className="menu-item__details--price">113 PER BOTTLE</p>

          <h5 className="menu-item__header">DOM PERIGNON 2006 CHAMPAGNE</h5>
          <p className="menu-item__details--description">FRANCE</p>
          ...
          <h5 className="menu-item__header">BARONE FINI</h5>
          <p className="menu-item__details--description">PINOT GRIGIO</p>
          <p className="menu-item__details--price">8 PER GLASS</p>
          <p className="menu-item__details--price">28 PER BOTTLE</p>

          <h5 className="menu-item__header">BROADSIDE CHARDONNAY</h5>
          <p className="menu-item__details--description">WASHINGTON</p>
          <p className="menu-item__details--price">9 PER GLASS</p>
          <p className="menu-item__details--price">32 PER BOTTLE</p>

          <h5 className="menu-item__header">LA PETITE SAUVIGNON BLANC</h5>
          <p className="menu-item__details--description">FRANCE</p>
          <p className="menu-item__details--price">7 PER GLASS</p>
          <p className="menu-item__details--price">24 PER BOTTLE</p>

          <h5 className="menu-item__header">HUNKY DORY SAUVIGNON BLANC</h5>
          <p className="menu-item__details--description">NEW ZEALAND</p>
          <p className="menu-item__details--price">10 PER GLASS</p>
          <p className="menu-item__details--price">35 PER BOTTLE</p>

          <h5 className="menu-item__header">WILLAMETTE VALLEY RIESLING</h5>
          <p className="menu-item__details--description">OREGON</p>
          <p className="menu-item__details--price">9 PER GLASS</p>
          <p className="menu-item__details--price">32 PER BOTTLE</p>
        </div>
